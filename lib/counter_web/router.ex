defmodule CounterWeb.Router do
  ...
  scope "/", CounterWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{CounterWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", CounterWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{CounterWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", CounterWeb do
    ...
    live_session :current_user,
      on_mount: [{CounterWeb.UserAuth, :mount_current_user}] do
